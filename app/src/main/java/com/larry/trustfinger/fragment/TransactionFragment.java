...
import com.larry.trustfinger.Activities.SubmitTransactionActivity;
                    ...
                    editor = sharedpreferences.edit();
                     ...
                     String auditsId = sharedpreferences.getString("auditId", "");
                        if (idd.equals(idnumber)) {
                            ...
                            @SuppressLint("DefaultLocale") final String amt = String.format("%.2f", amount);
                            ...
                            handleMsg("Fingerprint does not match", Color.RED);
