...
import com.larry.trustfinger.Activities.FingerPrintsupdateActivity;
...
import com.larry.trustfinger.adapter.MyListAdapter;
...
import com.larry.trustfinger.widget.FingerView;
import com.larry.trustfinger.widget.MyListView;
import com.larry.trustfinger.widget.OpenFileDialog;
...
public class AgentMembersFragment extends BaseFragment implements View.OnClickListener {
    private static final String TAG = "AgentMembersFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (root == null) {
            ...
            root = inflater.inflate(R.layout.fragment_agent_members, container, false);
...
//        }
        ...
        protected Void doInBackground(Void... voids) {
            ...
            do {
                ...
                try {
                    ...
                    if ((imageQuality < 20 || imageQuality == 0) && !largestFingerData.isIsrRaise
            ...
            if (fpFeatureData1 != null && fpFeatureData2 != null && fpFeatureData3 != null) {
                ...
                try {
                    ...
                    if (templateData != null) {
                        enrollFingerprint(templateData);
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                enbleSettingsView(true);
    ...
    private void enrollFingerprint(byte[] templateData) {
        User user = new User();
        String mUserID = mEditText_user_id.getText().toString().trim();
        String mUserFirstName = mEditText_user_first_name.getText().toString().trim();
        ...
        if (mDBHelper.insertUser(user)) {
            ...
            String fingerPs = user.getFingerData().getFingerPositions().toString().replaceAll("[\\[\\](){}]","");
                FingurePrintModel fingurePrint = new FingurePrintModel(user.getFingerData().toString(), user.getId(), machineId, id,fingerPs);
