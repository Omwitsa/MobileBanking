...
import com.larry.trustfinger.utils.DateUtil;
...
public class WithdrawalsreportActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_withdrawalsreport);
        mPrintReceiptBtn = (Button) findViewById(R.id.btn_print_draw);
        ...
        new Thread() {
            public void run() {
                ...
                SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurAppDir + "/" + "\0"), WithdrawalsreportActivity.this, new ISdkStatue() {
                    @Override
        ...
        Transsdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(WithdrawalsreportActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_print_draw:
                ...
                {
                    Toast.makeText(WithdrawalsreportActivity.this, "Printer Not Ready,Try again ", Toast.LENGTH_SHORT).show();
