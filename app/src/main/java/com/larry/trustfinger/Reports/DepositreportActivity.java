...
public class DepositreportActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depositreport);
        mPrintReceiptBtn = (Button) findViewById(R.id.btn_print_deposits);
        ...
        new Thread() {
            public void run() {
                ...
                SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurAppDir + "/" + "\0"), DepositreportActivity.this, new ISdkStatue() {
                    @Override
        ...
        Transsdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(DepositreportActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_print_deposits:
                ...
                {
                    Toast.makeText(DepositreportActivity.this, "Printer Not Ready,Try again ", Toast.LENGTH_SHORT).show();
