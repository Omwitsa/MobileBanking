...
import com.larry.trustfinger.fragment.TransactionFragment;
...
public class TransactionActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    ...
    @BindView(R.id.retry) Button mtry;
...
//            mVerifyFragment.setDatas(mTrustFingerDevice);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                new AlertDialog.Builder(TransactionActivity.this)
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(TransactionActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(TransactionActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, TransactionActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
...
//        fragmnts.add(mVerifyFragment);
        ...
        titles = getResources().getStringArray(R.array.tabs_name1);
