...
import com.larry.trustfinger.fragment.VerifyFragment;
...
public class AdminLoginActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    ...
    @BindView(R.id.identify) Button news;
...
//            mVerifyFragment.setDatas(mTrustFingerDevice);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                new AlertDialog.Builder(AdminLoginActivity.this)
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(AdminLoginActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(AdminLoginActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, AdminLoginActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
