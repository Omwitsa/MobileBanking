...
public class FingeprintActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    ...
    private MyApplication mApp;PosManager mPosManager;
...
//    @BindView(R.id.verification) Button verification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if (IsAdmin.equals("Complete")) {
...
//            mVerifyFragment.setDatas(mTrustFingerDevice);
    ...
    private void requestPermissions() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new AlertDialog.Builder(FingeprintActivity.this)
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(FingeprintActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(FingeprintActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, FingeprintActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
