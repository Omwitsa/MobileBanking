...
import com.larry.trustfinger.fragment.IdentifyFragment;
...
public class IdentificationActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    ...
    private void initTrustFinger() {
        try {
            ...
            System.exit(0);
            //mPosManager.fingerSwitchOff();
            Intent intent = new Intent(getApplicationContext(), RefreshidentifyActivity.class);
            startActivity(intent);
...
//            mVerifyFragment.setDatas(mTrustFingerDevice);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                new AlertDialog.Builder(IdentificationActivity.this)
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(IdentificationActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(IdentificationActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, IdentificationActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
...
//        fragmnts.add(mVerifyFragment);
        ...
        titles = getResources().getStringArray(R.array.tabs_name2);
