...
public class AdvanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Name = findViewById(R.id.tvNameA);
        Advmount= findViewById(R.id.tvAmt);
        ...
        final String AdvanceLimitAmount = sharedpreferences.getString("MaximumAmount","");
        final String idn = sharedpreferences.getString("agtId", "");
        Advmount.setText(AdvanceLimitAmount);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (advamount.isEmpty()) {
                    ...
                    Toast.makeText(AdvanceActivity.this, "Enter Amount to Apply ", Toast.LENGTH_LONG).show();
                } else {
