...
public class HomeActivity extends AppCompatActivity {
    ...
    @BindView(R.id.transk) CardView CheckTrans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deposit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("Mnumber",id_number);
        ...
        CheckTrans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), TransActionEnquiryActivity.class);
                editor.putString("supplierNo", Account);
                editor.commit();
                //intent.putExtra("supplierNo", Account);
                startActivity(intent);
