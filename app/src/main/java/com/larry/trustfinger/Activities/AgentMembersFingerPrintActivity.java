...
import com.larry.trustfinger.fragment.AgentMembersFragment;
...
public class AgentMembersFingerPrintActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    private static final String TAG = "AgentMembersFingerPrintActivity";
    ...
    private AgentMembersFragment mAgentMembersFragment;
...
//    @BindView(R.id.verification) Button verification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agent_members_finger_print);
...
//            mIdentifyFragment.setDatas(mTrustFingerDevice);
        if (mAgentMembersFragment != null)
            mAgentMembersFragment.setDatas(mTrustFingerDevice);
    ...
    private void requestPermissions() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new AlertDialog.Builder(AgentMembersFingerPrintActivity.this).setMessage("This app need to open the permissions").setPositiveButton("Settings", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(AgentMembersFingerPrintActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(AgentMembersFingerPrintActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, AgentMembersFingerPrintActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
...
//                    }
                            if (position == 0) {
                                mAgentMembersFragment.forceStop();
                                mAgentMembersFragment.resetUI();
                            }
//                    if (position == 3) {
...
//        mCaptureFragment.setLedCallback(this);
        mAgentMembersFragment = new AgentMembersFragment();
        mAgentMembersFragment.setLedCallback(this);
...
//        fragmnts.add(mCaptureFragment);
        fragmnts.add(mAgentMembersFragment);
