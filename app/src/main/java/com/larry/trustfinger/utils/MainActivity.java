...
public void PrintInfo()
{
    ...
    public void PrtCardInfo() {
        ...
        String BalAcc = sharedpreferences.getString("Acc_Name","");
        String BalAgency = sharedpreferences.getString("Agency_Name","");
        String DepAcc = sharedpreferences.getString("AccountName","");
        String DepAgency = sharedpreferences.getString("AgencyName","");
        String DepName = sharedpreferences.getString("Trans_Name","");
        String DepRef = sharedpreferences.getString("Trans_Ref","");
        if(transaction.equals("EasyAgent withdrawal"))
        {
            PrinterApi.PrnClrBuff_Api();
            PrinterApi.printSetAlign_Api(0);
            PrinterApi.PrnFontSet_Api(32, 32, 0);
            ...
            PrinterApi.PrnStr_Api("Account Name :"  + "\n");
            PrinterApi.PrnStr_Api( DepAcc + "\n");
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
            PrinterApi.PrnStr_Api("Date:" + date1 + "" + "," + "Time:" + time1 + "" + "\n");
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
            PrinterApi.PrnStr_Api("Thank you for your Patronage" + "\n");
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
        ...
        else if(transaction.equals("EasyAgent deposit"))
        {
            PrinterApi.PrnClrBuff_Api();
            PrinterApi.printSetAlign_Api(0);
            PrinterApi.PrnFontSet_Api(32, 32, 0);
            ...
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
            PrinterApi.PrnStr_Api("Date:" + date1 + "" + "," + "Time:" + time1 + "" + "\n");
            PrinterApi.PrnStr_Api("Deposited by" + "\n");
            PrinterApi.PrnStr_Api( DepName + "\n");
            PrinterApi.PrnStr_Api("Reference :" + DepRef + "\n");
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
            PrinterApi.PrnStr_Api("Thank you for your Patronage" + "\n");
            PrinterApi.PrnStr_Api("--------------------------" + "\n");
            PrinterApi.PrnStr_Api("DESIGNED & DEVELOPED BY" + "\n");
        ...
        else if(transaction.equals("Reprint"))
        {
            String MemberACCno = sharedpreferences.getString("MemberACCno", "");
            String Acc_name_1 = sharedpreferences.getString("Acc_name_1", "");
            String Activity_1 = sharedpreferences.getString("Activity_1", "");
            String Amount_1 = sharedpreferences.getString("Amount_1", "");
            String Vno_1 = sharedpreferences.getString("Vno_1", "");
            String Reprint_Agency_1 = sharedpreferences.getString("Reprint_Agency_1", "");
            String RepDate_1 = sharedpreferences.getString("RepDate_1", "");
            String REpName_1 = sharedpreferences.getString("REpName_1", "");
            String RePID_1 = sharedpreferences.getString("RePID_1", "");
            if (Activity_1.equals("EasyAgent Balance")) {
                PrinterApi.PrnClrBuff_Api();
                PrinterApi.printSetAlign_Api(0);
                PrinterApi.PrnFontSet_Api(32, 32, 0);
                PrinterApi.PrnSetGray_Api(15);
                ...
                PrinterApi.PrnStr_Api("\n" + Reprint_Agency_1 + "\n");
                PrinterApi.PrnStr_Api("Customer Copy \n");
                PrinterApi.PrnStr_Api(Activity_1.toUpperCase() + " RECEIPT" + "\n");
                PrinterApi.PrnStr_Api("ReceiptNumber :" + Vno_1 + "\n");
                PrinterApi.PrnStr_Api("Amount   :" + Amount_1 + "\n");
                PrinterApi.PrnStr_Api("Account NO   :" + MemberACCno + "\n");
                PrinterApi.PrnStr_Api("Account Name :" + "\n");
                PrinterApi.PrnStr_Api(Acc_name_1 + "\n");
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("Date:" + RepDate_1 + "\n");
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("Thank you for your Patronage" + "\n");
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("DESIGNED & DEVELOPED BY" + "\n");
            ...
            } else if (Activity_1.equals("EasyAgent Deposit"))
            {
                PrinterApi.PrnClrBuff_Api();
                PrinterApi.printSetAlign_Api(0);
                PrinterApi.PrnFontSet_Api(32, 32, 0);
                ...
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("Date:" + RepDate_1 + "\n");
                PrinterApi.PrnStr_Api(Activity_1 + "  by :" + "\n");
                PrinterApi.PrnStr_Api(REpName_1 + "\n");
                PrinterApi.PrnStr_Api("Reference :" + RePID_1 + "\n");
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("Thank you for your Patronage" + "\n");
                PrinterApi.PrnStr_Api("--------------------------" + "\n");
                PrinterApi.PrnStr_Api("DESIGNED & DEVELOPED BY" + "\n");
            ...
            else if (Activity_1.equals("EasyAgent Withdrawal")) {
                PrinterApi.PrnClrBuff_Api();
                PrinterApi.printSetAlign_Api(0);
                PrinterApi.PrnFontSet_Api(32, 32, 0);
                PrinterApi.PrnSetGray_Api(15);
            ...
            else if(transaction.equals("EasyAgent balance"))
                {
                        PrinterApi.PrnClrBuff_Api();
                        PrinterApi.printSetAlign_Api(0);
                        PrinterApi.PrnFontSet_Api(32, 32, 0);
