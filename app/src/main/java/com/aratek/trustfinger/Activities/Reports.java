    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread() {
            public void run() {
                ...
                SystemApi.SystemInit_Api(0, CommonConvert.StringToBytes(CurAppDir + "/" + "\0"), Reports.this, new ISdkStatue() {
                    @Override
        ...
        switch (v.getId()) {
            case R.id.btn_print_receiptd:
                if (pflag == 1) {
                    ...
                    Toast.makeText(Reports.this, "Not prepare well!", Toast.LENGTH_SHORT).show();
                    break;
                }
        }
