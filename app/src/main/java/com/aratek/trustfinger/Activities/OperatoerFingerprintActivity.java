...
import com.aratek.trustfinger.fragment.OperatorFragment;
...
public class OperatoerFingerprintActivity extends FragmentActivity implements DeviceOpenListener, LedCallback {
    private static final String TAG = "OperatoerFingerprintActivity";
...
//    @BindView(R.id.verification) Button verification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operatoer_fingerprint);
    ...
    public  void initTrustFinger() {
        try {
            ...
            handleMsg("TrustFinger getInstance Exception: " + e.getType().toString() + "", Color
                    .RED);
            System.exit(0);
            Intent intent = new Intent(getApplicationContext(), RefreshOperatorFingerprintActivity.class);
            startActivity(intent);
...
//            mIdentifyFragment.setDatas(mTrustFingerDevice);
        if (mOperatorFragment != null)
            mOperatorFragment.setDatas(mTrustFingerDevice);
    ...
    private void requestPermissions() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new AlertDialog.Builder(OperatoerFingerprintActivity.this).setMessage("This app need to open the permissions").setPositiveButton("Settings", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(OperatoerFingerprintActivity.this, "Permissions denied!", Toast
                                        .LENGTH_SHORT).show();
                                finish();
                            }
                        })
    ...
    private void initDatas() {
        ...
        adapter_usbDevice = new ArrayAdapter<String>(OperatoerFingerprintActivity.this, R.layout
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isDeviceOpened) {
                            ...
                            try {
                                mTrustFinger.openDevice(mDeviceId, OperatoerFingerprintActivity.this);
                            }
                            catch (TrustFingerException e) {
                                mButton_openClose.setEnabled(true);
...
//                    }
                            if (position == 0) {
                                mOperatorFragment.forceStop();
                                mOperatorFragment.resetUI();
                            }
//                    if (position == 3) {
...
//        mCaptureFragment.setLedCallback(this);
        mOperatorFragment = new OperatorFragment();
        mOperatorFragment.setLedCallback(this);
...
//        fragmnts.add(mCaptureFragment);
        fragmnts.add(mOperatorFragment);
